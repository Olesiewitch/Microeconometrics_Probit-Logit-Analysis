...
## as oppose to model a) where we assume unchanged magnitude of the effect, independet of the ldl value. 
## In estimation d) the marginal effect of ldl^2  has a negative coefficient, which tells us that the function of the marginal effects of ldl^2 is concaved. 
