...
vars_1 = data.frame(sen_1, spec_1)
colnames(vars)= c("Sensitivity","Specificity")
kable(vars_1)
```
...
vars_2 = data.frame(sen_2, spec_2)
colnames(vars)= c("Sensitivity","Specificity")
kable(vars_2)
```
...
vars_3 = data.frame(sen_3, spec_3,a$optimalCutoff )
colnames(vars)= c("Sensitivity","Specificity", "Optimal Cut off")
kable(vars_3)
```
