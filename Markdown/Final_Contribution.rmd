...
\left( 
\begin{array} { c } 
{ X _ { 0 } } \\ { \varepsilon _ { 1 } ^ { 0 } } \end{array} \right) \sim N \left[ \left( \begin{array} { c } { 10 } \\ { 0 } \end{array} \right) , \left( \begin{array} { c c } { 2 ^ { 2 } } & { 0 } \\ { 0 } & { 1 } \end{array} \right) \right] , \left( \begin{array} { c } { X _ { 0 } } \\ { \varepsilon _ { 2 } ^ { * } } \end{array} \right) \sim N \left[ \left( \begin{array} { c } { 10 } \\ { 0 } \end{array} \right) , \left( \begin{array} { c c } { 2 ^ { 2 } } & { 0 } \\ { 0 } & { 2 ^ { 2 } } \end{array} \right) \right] , \left( \begin{array} { c } { X _ { 0 } } \\ { \varepsilon _ { 3 } ^ { * } } \end{array} \right) \sim N \left[ \left( \begin{array} { c } { 10 } \\ { 0 } \end{array} \right) , \left( \begin{array} { c c } { 2 ^ { 2 } } & { 3 } \\ { 3 } & { 2 ^ { 2 } } \end{array} 
\right) \right]
$$
...
{ \text { and } \hat { E } [ A M P E | j = 3 ] .
 \text { Which estimate would you use to ascertain the effect of } }
\\
{ \text {the variable } x _ { 1 } ? } 
\end{array}
$$
...
$$
\begin{array} { l } 
{ \text { d) Finally, estimate the model from a ) but include ldl  
squared next to ldl as a  } } 
\\ 
...
{ \text { i.) } 
[ 1 \mathrm { P } ] 
\text {Based on the estimated coefficients from a) and d) draw the two}}
\\
{ \text { resulting marhinal probability effects of ldl as a function of ldl} \in \text{[1; 15] }}
\\ 
{ \text {next to each other. } } 
\end{array}
$$
...
{ \text { ii.) } 
[ 0.5 \mathrm { P } ] 
\text { Are any of the marginal probability effects linear in ldl? Explain why.} } 
\end{array}
$$
```{r, echo=FALSE}
...
{ \text { iii.) } 
[ 1 \mathrm { P } ] 
\text { What is the advantage of the marginal probability effect based on the} } 
\\
{ \text { estimation in d ) over the one based on a)? Explain shortly.} }
\end{array}
$$
```{r, echo=FALSE}
...
{ \text { iv.) } 
[ 1.5 \mathrm { P } ] 
\text { Calculate and properly interpret both marginal probability effects for} } 
\\
{ \text { the mean value of ldl in the sample.} }
\end{array}
$$
